...
const WBTC_ETHW = WBTC_ETH

export const ROUTER_ADDRESS: ChainMap<string> = {
  [ChainId.ETHW]: '0xEfF92A263d31888d860bD50809A8D171709b7b1c',
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.ETHW]: [WNATIVE[ChainId.ETHW], USDC[ChainId.ETHW], USDT[ChainId.ETHW], WBTC_ETHW],
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.ETHW]: [USDC[ChainId.ETHEREUM], USDT[ChainId.ETHEREUM], WNATIVE[ChainId.ETHEREUM], WBTC_ETH],
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.ETHW]: [USDC[ChainId.ETHEREUM], WNATIVE[ChainId.ETHEREUM], USDT[ChainId.ETHEREUM], WBTC_ETH],
  [ChainId.RINKEBY]: [USDC[ChainId.RINKEBY], WNATIVE[ChainId.RINKEBY], BUSD[ChainId.RINKEBY]],
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
